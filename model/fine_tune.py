...
if __name__ == '__main__':
    ...
    model_dict = torch.load('/home/gaoqiyu/PycharmProjects/MinkowskiEngine/resume/weights.pth')
    ...
    model.final = tmp
    torch.save(model.state_dict(), '/home/gaoqiyu/PycharmProjects/MinkowskiEngine/resume/weights_14.pth', )
