from model.resnet import ResNetBase
from model.common import ConvType, NormType, conv, conv_tr
from model.resnet_block import BasicBlock, Bottleneck, BasicBlockSN, BottleneckSN, BasicBlockIN, BottleneckIN, BasicBlockLN
...
class ResUNetBase(ResNetBase):
  ...
  def __init__(self, in_channels, out_channels, D=3, **kwargs):
    super(ResUNetBase, self).__init__(in_channels, out_channels, D)
...
class ResUNetTemporalBase(ResUNetBase):
  ...
  def __init__(self, in_channels, out_channels, D=4, **kwargs):
    super(ResUNetTemporalBase, self).__init__(in_channels, out_channels, D, **kwargs)
...
class STResUNetBase(ResUNetBase):
  ...
  def __init__(self, in_channels, out_channels, D=4, **kwargs):
    super(STResUNetBase, self).__init__(in_channels, out_channels, D, **kwargs)
